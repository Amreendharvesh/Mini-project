...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: #7393B3">
        <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: #89CFF0"> J Car Rentals</h1>
                            <p class="intro-text"><marquee width="550" direction="right" height="90"> Welcome to J Car Rental Online Service!!! </marquee>
